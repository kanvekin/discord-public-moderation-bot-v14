module.exports = {
    ...
    presence: "Kanvekin Was Here", //Botun Durumu
    footer: "kanvekin & 82", //Embedların Footer Yazısı
    botOwners: [""], //Bot Sahibinin ID'si
    prefix: ".", //Botun Prefix'i 
    manemoji: "", //Erkek Emojisi Örnek Olarak : "♂️"
    womanemoji: "", //Kadın Emojisi Örnek Olarak : "♀️"
    tagSymbol: "", //Sunucunun Taglı İsim Sembolu => Eğer Tagınız Yoksa Boş Bırakın Veya Örnek Olarak : "•"
    normalSymbol: "", //Normal Kayıt Olucak Kullanıcıların Başına Gelicek Sembol Örnek Olarak : "•"
    symbolkanvekin: "", //Kayıt Esnasında İsim Ve Yaş'ı Ayıran Çizgi Örnek Olarak : "|"
