...
module.exports = {
    name: "forceban",
    usage:"forceban [@kanvekin / ID] <sebep>",
    category:"moderasyon",
    ...
    execute: async (client, message, args, kanvekin_embed) => {
        ...
        if(forcedata.includes(member.id)) return message.reply({ embeds: [kanvekin_embed.setDescription(`> **Belirtilen Üyenin Zaten Bir Kalıcı Yasaklaması Bulunmakta!**`)]}).sil(5);
