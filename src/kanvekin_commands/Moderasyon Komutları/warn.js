...
module.exports = {
    ...
    execute: async (client, message, args, kanvekin_embed) => {
        ...
        if(!member.bannable)return message.reply({ embeds: [kanvekin_embed.setDescription(`> **Belirtilen User'a İşlem Yapmaya Yetkim Yetmiyor!**`)]}).sil(5);
